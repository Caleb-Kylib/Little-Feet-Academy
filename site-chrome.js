...
(function () {
  ...
  function buildNavbar(active) {
    ...
    return (
      ...
      '<img src="assets/img/school-logo.png" alt="Little Feet Academy logo" class="navbar-logo" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'flex\';" />' +
